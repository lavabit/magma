...
C_SRCS += \
../engine/controller/protocol.c \
../engine/controller/queue.c 

OBJS += \
./engine/controller/protocol.o \
./engine/controller/queue.o 

C_DEPS += \
./engine/controller/protocol.d \
./engine/controller/queue.d 


# Each subdirectory must supply rules for building sources it contributes
engine/controller/%.o: ../engine/controller/%.c
	@echo 'Building file: $<'
