...
DIME_CHECK_CPPFILES				= $(foreach dir, $(DIME_CHECK_CPPDIRS), $(wildcard $(dir)/*.c))
DIME_CHECK_SRCFILES				= $(filter-out $(FILTERED_SRCFILES), $(foreach dir, $(DIME_CHECK_SRCDIRS), $(wildcard $(dir)/*.cpp)))
DIME_CHECK_CPPFILES				+= lib/sources/googtest/src/gtest-all.cc
...
all: config warning setup $(MAGMA_PROGRAM) $(DIME_PROGRAM) $(SIGNET_PROGRAM) $(GENREC_PROGRAM) $(MAGMA_CHECK_PROGRAM)

setup: $(PACKAGE_DEPENDENCIES)

check: config warning $(MAGMA_CHECK_PROGRAM) finished
...
clean:
	@$(RM) $(MAGMA_PROGRAM) $(MAGMA_CHECK_PROGRAM) $(DIME_PROGRAM) $(SIGNET_PROGRAM) $(GENREC_PROGRAM)
	@$(RM) $(MAGMA_OBJFILES) $(MAGMA_CHECK_OBJFILES) $(DIME_OBJFILES) $(SIGNET_OBJFILES) $(GENREC_OBJFILES)  
	@$(RM) $(MAGMA_DEPFILES) $(MAGMA_CHECK_DEPFILES) $(DIME_DEPFILES) $(SIGNET_DEPFILES) $(GENREC_DEPFILES)
...
-include $(MAGMA_DEPFILES) $(DIME_DEPFILES) $(SIGNET_DEPFILES) $(GENREC_DEPFILES) $(MAGMA_CHECK_DEPFILES) 
