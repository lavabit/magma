...
INSERT INTO `Users` (`usernum`, `userid`, `salt`, `auth`, `bonus`, `legacy`, `tls`, `plan`, `locked`, `advertising`, `domain`, `email`, `chat`, `timezone`, `size`, `quota`, `overquota`, `plan_expiration`, `lock_expiration`) VALUES (13,'approver','Xe9N_tWGDHT_ivAsn6TeRGh0rBAGISSd4TEjyTsoQb6akmZeTM_kT62m064g8-o8sMhsUWfhroo0ZF5Hf2oGapTlgOuv6CxvNUKFV7YltfJLb9bgKKiSoXtCCkGO-69G4X1OWkdLBm2N5lEUpsNJ1lxNpJU59fdUkiM12lgKhsU','DDyOJgh2N6doEtoKMw_ZkacavE2-jkWt4P6z9E_FHB88Q0xxJxq_G3kTqPfl4YRvkDqGOdziOLjNQFrdlkiuaA',0,NULL,1,'PREMIER',0,0,NULL,1,1,0,0,21474836480,0,'2018-08-06','0000-00-00');
...
INSERT INTO `Mailboxes` (`address`, `usernum`) VALUES ('approver',13);
...
INSERT INTO `Folders` (`foldernum`, `usernum`, `foldername`, `order`, `type`, `parent`) VALUES (13,13,'Inbox',0,1,0);
...
INSERT INTO `Dispatch` (`usernum`, `secure`, `forwarded`, `rollout`, `bounces`, `greylist`, `greytime`, `rbl`, `rblaction`, `spf`, `spfaction`, `dkim`, `dkimaction`, `spam`, `spamaction`, `spamfolder`, `virus`, `virusaction`, `phish`, `phishaction`, `filters`, `autoreply`, `inbox`, `send_size_limit`, `recv_size_limit`, `daily_send_limit`, `daily_recv_limit`, `daily_recv_limit_ip`, `class`) VALUES (13,1,'',0,1,0,1,0,'REJECT',0,'REJECT',0,'MARK',0,'MARK',13,1,'DELETE',1,'DELETE',0,NULL,13,134217728,134217728,128,8192,8192,0);
...
INSERT INTO `Log` (`usernum`, `lastpop`, `lastmap`, `lastweb`, `lastchat`, `lastsent`, `lastreceived`, `popsessions`, `mapsessions`, `websessions`, `chatsessions`, `totalsent`, `totalreceived`, `totalbounces`, `created`, `created_ip`) VALUES (13,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00',0,0,0,0,0,0,0,'2019-06-06 22:12:10','127.0.0.1');
...
INSERT INTO `Profile` (`usernum`, `name`, `address_one`, `address_two`, `city`, `state`, `zip`, `country`, `profile`, `phone`, `mobile`, `fax`, `gender`, `language`, `birthdate`, `industry`, `website`, `accessible`) VALUES (13,'','','','','',0,'',NULL,'','','',NULL,'','0000-00-00','','',0);
...
INSERT INTO `Realms` (`usernum`, `serial`, `label`, `shard`, `rotated`) VALUES (13,0,'mail','BzQ9Ffu1Py5yuhhQeJDH6l9KA0o-TgDce6M6aF-vL1ueXNYVDCAluxlITP4UJE17_3sAXjl6v6etGn7jB-Bb0Q',1);
...
UPDATE `Users` SET `admin` = 2 WHERE `userid` = 'approver';
