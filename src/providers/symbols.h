...
extern int (*cl_scandesc_d)(int desc, const char **virname, unsigned long int *scanned, const struct cl_engine *engine, struct cl_scan_options *scanoptions);
...
extern SSL_CIPHER * (*SSL_get_current_cipher_d)(const SSL *ssl);
