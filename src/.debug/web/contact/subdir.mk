...
C_SRCS += \
../web/contact/abuse.c \
../web/contact/business.c \
../web/contact/contact.c 

OBJS += \
./web/contact/abuse.o \
./web/contact/business.o \
./web/contact/contact.o 

C_DEPS += \
./web/contact/abuse.d \
./web/contact/business.d \
./web/contact/contact.d 


# Each subdirectory must supply rules for building sources it contributes
web/contact/%.o: ../web/contact/%.c
	@echo 'Building file: $<'
