...
C_SRCS += \
../engine/status/build.c \
../engine/status/performance.c \
../engine/status/statistics.c \
../engine/status/status.c 

OBJS += \
./engine/status/build.o \
./engine/status/performance.o \
./engine/status/statistics.o \
./engine/status/status.o 

C_DEPS += \
./engine/status/build.d \
./engine/status/performance.d \
./engine/status/statistics.d \
./engine/status/status.d 


# Each subdirectory must supply rules for building sources it contributes
engine/status/%.o: ../engine/status/%.c
	@echo 'Building file: $<'
