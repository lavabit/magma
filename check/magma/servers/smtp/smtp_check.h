...
bool_t check_smtp_checkers_filters_sthread(stringer_t*);

/// smtp_check.h
bool_t check_smtp_client_read_line_to_end(client_t*);
bool_t check_smtp_network_simple_sthread(stringer_t*);
