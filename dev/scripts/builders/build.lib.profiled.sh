...
gd() {
	...
	case "$1" in
		...
		gd-build)
			cd "$M_SOURCES/gd"; error
			export CFLAGS="-pg -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CXXFLAGS="-pg -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CPPFLAGS="-pg -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			...
			export LDFLAGS="\
				...
				-L$M_SOURCES/freetype/objs/.libs -Wl,-rpath,$M_SOURCES/freetype/objs/.libs -pg"
...
png() {
	...
	case "$1" in
		...
		png-build)
			cd "$M_SOURCES/png"; error
			export CFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CXXFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CPPFLAGS="$CPPFLAGS -I$M_SOURCES/zlib"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -L$M_SOURCES/zlib -Wl,-rpath,$M_SOURCES/zlib"
...
spf2() {
	...
	case "$1" in
		...
		spf2-build)
			cd "$M_SOURCES/spf2"; error
			export CFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export CXXFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage"
...
curl() {
	...
	case "$1" in
		...
		curl-build)
			...
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -L$M_SOURCES/openssl -Wl,-rpath,$M_SOURCES/openssl \
				-L$M_SOURCES/zlib -Wl,-rpath,$M_SOURCES/zlib"
	...
	case "$1" in
		...
		dkim-build)
			...
			export LDFLAGS="\
				...
				-L$M_SOURCES/openssl/engines -Wl,-rpath,$M_SOURCES/openssl/engines -pg -finstrument-functions -fprofile-arcs -ftest-coverage"
			./configure \
...
zlib() {
	...
	case "$1" in
		...
		zlib-build)
			...
			export CFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export FFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CXXFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage"
...
bzip2() {
	...
	case "$1" in
		...
		bzip2-build)
			cd "$M_SOURCES/bzip2"; error
			make CC=gcc AR=ar RANLIB=ranlib 'CFLAGS=-pg -finstrument-functions -fprofile-arcs -ftest-coverage -O2 -g3 -fPIC -rdynamic -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic -D_FILE_OFFSET_BITS=64' &>> "$M_LOGS/bzip2.txt"; error
...
dspam() {
	...
	case "$1" in
		...
		dspam-build)
			...
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CPPFLAGS="$CPPFLAGS -I$M_SOURCES/zlib"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -L$M_SOURCES/zlib"
...
mysql() {
	...
	case "$1" in
		...
		mysql-build)
			cd "$M_SOURCES/mysql"; error
			export CFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export CXXFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2"
			export CPPFLAGS="$CPPFLAGS -I$M_SOURCES/zlib"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -L$M_SOURCES/zlib -Wl,-rpath,$M_SOURCES/zlib"
...
clamav() {
	...
	case "$1" in
		...
		clamav-build)
			cd "$M_SOURCES/clamav"; error
			export CFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2 -DGNU_SOURCE"
			export CXXFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2 -DGNU_SOURCE"
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2 -DGNU_SOURCE"
			export CPPFLAGS="$CPPFLAGS \
			...
			export LDFLAGS="\
				...
				-L$M_SOURCES/openssl -Wl,-rpath,$M_SOURCES/openssl\
				-L$M_SOURCES/zlib -Wl,-rpath,$M_SOURCES/zlib -pg -finstrument-functions -fprofile-arcs -ftest-coverage"
	...
	case "$1" in
		...
		openssl-build)
		    ...
		    ./config \
				...
				-I"$M_SOURCES/zlib" -O $CONFIGOPTS -g3 -rdynamic -fPIC -DPURIFY -D_FORTIFY_SOURCE=2 -pg -finstrument-functions -fprofile-arcs \
				-L"$M_SOURCES/openssl" -Wl,-rpath,"$M_SOURCES/openssl" \
				-L"$M_SOURCES/zlib" -Wl,-rpath,"$M_SOURCES/zlib" \
				&>> "$M_LOGS/openssl.txt"; error
				
			rm -rf "$M_SOURCES/openssl/test"
...
freetype() {
	...
	case "$1" in
		...
		freetype-build)
			...
			export CPPFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage -fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2"
			export CPPFLAGS="$CPPFLAGS -I$M_SOURCES/zlib"
			export LDFLAGS="-L$M_SOURCES/zlib -Wl,-rpath,$M_SOURCES/zlib -pg -finstrument-functions -fprofile-arcs -ftest-coverage"
...
utf8proc() {
	...
	case "$1" in
		...
		utf8proc-build)
			cd "$M_SOURCES/utf8proc"; error
			export CFLAGS="-fPIC -g3 -rdynamic -D_FORTIFY_SOURCE=2 -O2 -pg -finstrument-functions -fprofile-arcs -ftest-coverage"
			export LDFLAGS="-pg -finstrument-functions -fprofile-arcs -ftest-coverage"
...
memcached() {
	...
	case "$1" in
		...
		memcached-build)
			...
			./configure --disable-silent-rules --disable-dtrace --disable-sasl --enable-debug --enable-static --enable-shared--with-pic \
...
tokyocabinet() {
	...
	case "$1" in
		...
		tokyocabinet-build)
			...
			export LDFLAGS="-L$M_SOURCES/zlib -L$M_SOURCES/bzip2 -pg -finstrument-functions -fprofile-arcs -ftest-coverage"
...
combine() {
	...
	gcc -Wl,-Bsymbolic -g3 -fPIC -rdynamic -shared -pg -finstrument-functions -fprofile-arcs -ftest-coverage -o "$M_SO" "$M_OBJECTS"/lzo/*.o "$M_OBJECTS"/zlib/*.o "$M_OBJECTS"/bzip2/*.o \
