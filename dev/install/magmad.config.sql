...
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[1].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[2].name', 'HTTP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[2].protocol', 'HTTP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[2].network.port', '80', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[2].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[3].name', 'POP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[3].protocol', 'POP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[3].network.port', '110', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[3].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[4].name', 'IMAP', NOW());
...
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[6].name', 'SUBMISSION', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[6].protocol', 'SUBMISSION', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[6].network.type', 'TLS', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[6].network.port', '465', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[6].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
...
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[7].network.port', '587', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[7].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[8].name', 'IMAP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[8].protocol', 'IMAP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[8].network.type', 'TLS', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[8].network.port', '993', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[8].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[9].name', 'POP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[9].protocol', 'POP', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[9].network.type', 'TLS', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[9].network.port', '995', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[9].tls.certificate', '/etc/pki/tls/private/$DOMAIN.pem', NOW());
INSERT INTO Host_Config (application, name, `value`, timestamp) VALUES ('magmad', 'magma.servers[10].name', 'MOLTEN', NOW());
