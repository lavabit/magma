...
static signet_t *sgnt_signet_load(const char *filename) {
	...
	if (!(b64_signet = _read_pem_data(filename, SIGNET_USER, 1)) && !(b64_signet = _read_pem_data(filename, SIGNET_ORG, 1))) {
...
static void sgnt_signet_dump(FILE *fp, signet_t *signet) {
	...
	for (int i = 0; i < SIGNET_FID_MAX + 1; ++i) {
		...
		if ((i == SIGNET_USER_CRYPTO_SIG && signet_type == SIGNET_TYPE_USER)
			|| (i == SIGNET_ORG_CRYPTO_SIG && signet_type == SIGNET_TYPE_ORG)) {
			fprintf(fp, "%-34s    %s\n", "------- End cryptographic signet",
				"------------------------------------------------------------------------------------------");
		}

		if ((i == SIGNET_USER_FULL_SIG && signet_type == SIGNET_TYPE_USER)
			|| (i == SIGNET_ORG_FULL_SIG && signet_type == SIGNET_TYPE_ORG)) {
			fprintf(fp, "%-34s    %s\n", "------- End full signet",
				"------------------------------------------------------------------------------------------");
		}
...
sgnt_signet_dupe(signet_t *signet) {
	...
	cleanup_copy: sgnt_signet_destroy(copy);
	error: return NULL;
}
 ...
 */
EC_KEY *
dime_sgnt_enckey_fetch(signet_t const *signet) {
 ...
 */
unsigned char *
dime_sgnt_fid_num_fetch(signet_t const *signet, unsigned char fid, unsigned int num, size_t *data_size) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_fid_num_fetch, signet, fid, num, data_size);
}
...
int dime_sgnt_field_defined_create(signet_t *signet, unsigned char fid, size_t data_size, unsigned char const *data) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_field_defined_create, signet, fid, data_size, data);
}
...
int dime_sgnt_field_defined_set(signet_t *signet, unsigned char fid, size_t data_size, const unsigned char *data) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_field_defined_set, signet, fid, data_size, data);
}
...
int dime_sgnt_field_undefined_create(signet_t *signet, size_t name_size, unsigned char const *name, size_t data_size, unsigned char const *data) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_field_undefined_create, signet, name_size, name, data_size, data);
}
 ...
 */
unsigned char *
dime_sgnt_field_undefined_fetch(signet_t const *signet, size_t name_size, unsigned char const *name, size_t *data_size) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_field_undefined_fetch, signet, name_size, name, data_size);
}
...
int dime_sgnt_field_undefined_remove(signet_t *signet, size_t name_size, unsigned char const *name) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_field_undefined_remove, signet, name_size, name);
}
 ...
 */
char *
dime_sgnt_fingerprint_crypto(signet_t const *signet) {
 ...
 */
char *
dime_sgnt_fingerprint_full(signet_t const *signet) {
 ...
 */
char *
dime_sgnt_fingerprint_id(signet_t const *signet) {
 ...
 */
char *
dime_sgnt_fingerprint_ssr(signet_t const *signet) {
...
int dime_sgnt_sig_coc_sign(signet_t *signet, ED25519_KEY *key) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_sig_coc_sign, signet, key);
}
...
int dime_sgnt_sig_full_sign(signet_t *signet, ED25519_KEY *key) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_sig_full_sign, signet, key);
}
 ...
 */
signet_t *
dime_sgnt_signet_binary_deserialize(unsigned char const *in, size_t len) {
 ...
 */
unsigned char *
dime_sgnt_signet_binary_serialize(signet_t *signet, uint32_t *serial_size) {
	PUBLIC_FUNCTION_IMPLEMENT(sgnt_signet_binary_serialize, signet, serial_size);
}
 ...
 */
signet_t *
dime_sgnt_signet_create_w_keys(signet_type_t type, char const *keysfile) {
 ...
 */
signet_t *
dime_sgnt_signet_crypto_split(signet_t const *signet) {
 ...
 */
signet_t *
dime_sgnt_signet_full_split(signet_t const *signet) {
 ...
 */
signet_t *
dime_sgnt_signet_load(char const *filename) {
 ...
 */
ED25519_KEY *
dime_sgnt_signkey_fetch(signet_t const *signet) {
 ...
 */
ED25519_KEY **
dime_sgnt_signkeys_msg_fetch(signet_t const *signet) {
 ...
 */
ED25519_KEY **
dime_sgnt_signkeys_software_fetch(signet_t const *signet) {
 ...
 */
ED25519_KEY **
dime_sgnt_signkeys_tls_fetch(signet_t const *signet) {
 ...
 */
ED25519_KEY *
dime_sgnt_sok_num_fetch(signet_t const *signet, unsigned int num) {
