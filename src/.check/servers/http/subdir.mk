...
C_SRCS += \
../servers/http/content.c \
../servers/http/data.c \
../servers/http/errors.c \
../servers/http/http.c \
../servers/http/parse.c \
../servers/http/response.c \
../servers/http/sessions.c 

OBJS += \
./servers/http/content.o \
./servers/http/data.o \
./servers/http/errors.o \
./servers/http/http.o \
./servers/http/parse.o \
./servers/http/response.o \
./servers/http/sessions.o 

C_DEPS += \
./servers/http/content.d \
./servers/http/data.d \
./servers/http/errors.d \
./servers/http/http.d \
./servers/http/parse.d \
./servers/http/response.d \
./servers/http/sessions.d 


# Each subdirectory must supply rules for building sources it contributes
servers/http/%.o: ../servers/http/%.c
	@echo 'Building file: $<'
