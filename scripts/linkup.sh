...
process "user.add.sh" "user.add"
process "user.rm.sh" "user.rm"
process "user.pwchange.sh" "user.pwchange"

process "mycon.sh" "mycon"
process "mua.reset.sh" "mua.reset"
process "freshen.metadata.sh" "freshen.metadata"
process "freshen.clamav.sh" "freshen.clamav"
process "freshen.geoip.sh" "freshen.geoip"
